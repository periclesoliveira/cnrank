...
public class CNRank {
   ...
   */
    ...
    */
	...
	if(isValidCN(match)) System.out.println(match);
	else {
...
*/
    public static void main(String[] args) {
	 ...
	 System.out.println("====== CANDIDATE NETWORKS  ================");
	    ...
	    String[] predicates = queryMatch.toArray(new String[queryMatch.size()]);
	    ...
	    String relations	=new String();
	      ...
	      for(String adj:rGraph.get(terminalEdgeRoot).values()) {
           ...
           System.out.print("CN "+contador+":");
	   modcngen(G,queryMatch,12,getKeywords(queryMatch));
           System.out.println("");	
           ++contador;
         } 
	 System.out.println("Total de CNs:"+contador);
      }
   }
}
