...
public class CNIGenTS {
   ...
   */
    ...
    */
    ...
    public static void createInvertedListTS(Connection conn,ArrayList<String> Q) throws SQLException
    {
        Integer attributeMapping = 1;
        boolean processTuple     = false;
        try {
                        ...
                        while (rs2.next()) {
                           ...
                           for(int x=1;x<=numberOfColumns;x++)
                           {
                                ...
                                if(rsMetaData.getColumnType(x)==12) {
                                 ...
                                 processTuple = false;
                                 for(String keywordTest: Q) {
                                  if(tupleKeywords!=null)
                                    if(tupleKeywords.toLowerCase().contains(keywordTest.toLowerCase())) processTuple = true;
                                 }
                                 if(processTuple) {
    ...
    private static void enumerate(Graph G, String v, String t) {
        ...
        if (v.equals(t))
        {
          ...
          if(steinerTrees.size()<10) steinerTrees.add(steinerTree);
        }
    ...
    public static void main(String[] args) {
       ...
       while(true) {
         ...
         try {
           ...
           createInvertedListTS(conn,Q);
           long time4=System.currentTimeMillis() ;
           System.out.println("Time to create term index="+(time4-time3)+"\n");
         } catch (SQLException se) {
            System.out.println("Couldn't connect: print out a stack trace and exit.");
            se.printStackTrace();
            System.exit(1);
